...
import { closeWindow, minimizeWindow, toggleMaximizeWindow } from "../../lib/desktop-shell";
...
export default function AppTitleBar() {
  ...
  return (
    <div
      ...
      className="h-[34px] min-h-[34px] flex items-center justify-between select-none app-chrome app-drag-region border-b-[0.5px] border-b-[var(--chrome-border)] shadow-[0_1px_0_rgba(0,0,0,0.25)]"
    >
      <div className="flex items-center gap-2 pl-4">
        <img src={logoSvg} alt="Logo" className="w-[16px] h-[16px] rounded-[3px]" />
        <span className="text-[12px] font-medium text-[var(--text-tertiary)]">Nexus</span>
      </div>
      <div className="flex items-center h-full text-[var(--text-tertiary)] app-no-drag">
        <button
