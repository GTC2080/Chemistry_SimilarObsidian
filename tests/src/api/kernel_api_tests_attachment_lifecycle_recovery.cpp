// Reason: This file isolates attachment recovery and reopen catch-up regressions so lifecycle coverage can stay readable as the formal public surface grows.
