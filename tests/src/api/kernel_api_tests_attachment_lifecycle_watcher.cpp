// Reason: This file isolates attachment watcher, rename, and full-rescan regressions so lifecycle behavior around external changes stays compact and navigable.
