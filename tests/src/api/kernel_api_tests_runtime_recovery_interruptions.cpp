// Reason: This file isolates watcher-backoff and interrupted-apply recovery regressions so startup recovery coverage can stay smaller and easier to navigate.
