// Reason: This file isolates core legacy note-search matching behavior so title and limit surface coverage can stay separate.
...
void run_search_legacy_note_basic_tests() {
