...
struct KernelAttachmentRecountSnapshot {
  std::string reason;
  std::uint64_t at_ns = 0;
};

struct KernelPdfRecountSnapshot {
  std::string reason;
  std::uint64_t at_ns = 0;
};
...
struct KernelChemistryRecountSnapshot {
  std::string reason;
  std::uint64_t at_ns = 0;
};
...
struct KernelRuntimeState {
  ...
  KernelChemistryRecountSnapshot last_chemistry_recount;
